...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tracker', '0003_organizationsaving_auditlog_groupsaving_membersaving_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='tracker.staff')),
            ],
            options={
                'ordering': ['-created_at'],
            },
